...
public class OcpSelectionTest {
    ...
    @Test
    public void propertyBased_choisitDaoApi_440() {
        // Positionner dao.target via System.setProperty
        String originalValue = System.getProperty("dao.target");
        try {
            System.setProperty("dao.target", "daoApi");
            
            AnnotationConfigApplicationContext ctx = new AnnotationConfigApplicationContext();
            // Activer tous les profils pour que tous les beans IDao soient disponibles
            ctx.getEnvironment().setActiveProfiles("prod", "dev", "file", "api");
            ctx.register(Presentation2.class);
            ctx.refresh();
            ...
            // Restaurer la valeur originale ou la supprimer
    ...
    @Test
    public void propertyBased_choisitDao2_300() {
        // Positionner dao.target via System.setProperty
        String originalValue = System.getProperty("dao.target");
        try {
